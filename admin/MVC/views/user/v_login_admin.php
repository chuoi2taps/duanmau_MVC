            ...
            <form action="login_admin.php" method="post">
                ...
                <div class="input">
                    ...
                    <?php if (isset($_COOKIE['error_login'])) { ?>
                        ...
                        <div class="error">
                            <svg style="color: red; background-color: #fff; padding: 3px; font-weight:800" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
