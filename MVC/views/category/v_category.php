            ...
            <div class="container">
                <div class="flex">
                    <div class="product" style="width: 100%;">
                        <div class="list">
                            <?php foreach ($product_with_category as $key => $value) : ?>
                                <div class="sp">
                        ...
                        <div class="page-number">
                            <ul>
                                <?php if ($current_page > 1) { ?>
                                    <li>
                                        <a href="?id_cate=<?= $category[0]->id_cate ?>&perpage=<?= $limit ?>&page=<?= $current_page - 1 ?>"><</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php for($i = 1; $i <= $total_pages; $i++): ?>
                                    <?php if ($current_page != $i ) { ?>
                                        <?php if ($i > $current_page - 3 && $i < $current_page + 3) { ?>
                                            <li>
                                                <a href="?id_cate=<?= $category[0]->id_cate ?>&perpage=<?= $limit ?>&page=<?= $i ?>"><?= $i ?></a>
                                            </li>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <li>
